    ...
    ReentrancyGuardUpgradeable
{
        ...
        onlyOwnerOrOperator
    {
        ...
        address idxTok = address(factoryStorage.indexToken());

        bool bondDeficit = functionsOracle.tokenCurrentMarketShare(bond) < functionsOracle.tokenOracleMarketShare(bond);

        bool riskDeficit =
            functionsOracle.tokenCurrentMarketShare(idxTok) < functionsOracle.tokenOracleMarketShare(idxTok);
